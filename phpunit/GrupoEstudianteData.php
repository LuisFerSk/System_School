...
class GrupoEstudianteData
{
	...
	public static function getByGrupoEstudiante($grupo, $estudiante)
	{
		$sql = "select * from " . self::$tablename . " where grupo = $grupo and estudiante=\"$estudiante\";";
		$query = Executor::doit($sql);
		return Model::one($query[0], new GrupoEstudianteData());
	}
