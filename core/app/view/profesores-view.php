  ...
  <section class="container">
    ...
    <form method="POST" action="./?action=profesores&opt=add">
      ...
      <div class="form-group col-md-2">
        <input type="hidden" name="num_cel" class="form-control" id="inputEmail4" placeholder="999999999">
      </div>
      <div class="form-group col-md-6">
        <input type="hidden" name="especialidad" class="form-control" id="inputEmail4" placeholder="especialidad">
      </div>
      <div class="form-group col-md-6">
        <input type="hidden" name="direccion" class="form-control" id="inputEmail4" placeholder="especialidad">
      </div>
      <div class=" col-lg-10">
      ...
      <div class="col-md-12">
        ...
        <form method="POST" action="./?action=profesores&opt=upd">
          <div class="form-group">
            ...
            <input type="hidden" name="especialidad" required value="<?= $profesor->especialidad; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            <input type="hidden" name="num_cel" required value="<?= $profesor->num_cel; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            ...
            <input type="hidden" name="direccion" required value="<?= $profesor->direccion; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
          </div>
